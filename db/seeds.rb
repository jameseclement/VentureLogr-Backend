...
aus = Trip.create(title: "Australia Summer 2016", date: Date.parse("June 1, 2016"), location: "Sydney", description: 'Spent a great summer in Sydney and Melbourne',
photo: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/Australia_Day.jpg')

southafrica = Trip.create(title: "South Africa Winter 2017", date: Date.parse("Feb 1, 2017"), location: "Cape Town", description: 'Wonderful time in cape town with family',
...
indonesia_day_2 = Entry.create({ title: "Day 2" , date: Date.parse("October 2, 2016"), story: story2, trip: indonesia})
...
aus_day_2 = Entry.create({ title: "Day 2" , date: Date.parse("June 2, 2017"), story: story2, trip: aus})
aus_day_3 = Entry.create({ title: "Day 3" , date: Date.parse("June 3, 2017"), story: story3, trip: aus})
aus_day_4 = Entry.create({ title: "Day 4" , date: Date.parse("June 4, 2017"), story: story2, trip: aus})

southafrica_day_1 = Entry.create({ title: "Day 1" , date: Date.parse("February 1, 2017"), story: story1, trip: southafrica})
southafrica_day_2 = Entry.create({ title: "Day 2" , date: Date.parse("February 2, 2017"), story: story2, trip: southafrica})
southafrica_day_3 = Entry.create({ title: "Day 3" , date: Date.parse("February 3, 2017"), story: story3, trip: southafrica})
southafrica_day_4 = Entry.create({ title: "Day 4" , date: Date.parse("February 4, 2017"), story: story2, trip: southafrica})

japan_day_1 = Entry.create({ title: "Day 1" , date: Date.parse("March 1, 2016"), story: story1, trip: japan})
japan_day_2 = Entry.create({ title: "Day 2" , date: Date.parse("March 2, 2016"), story: story2, trip: japan})
